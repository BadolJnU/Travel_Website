          ...
          <div className="booking__form">
            ...
            <Form className='booking_form-info' onSubmit={handleClick}>
                ...
                <FormGroup className='d-flex align-items-center gap-3'>
                    <input type="date" placeholder='' id='bookingDate' required onChange={handleChange}/>
                    <input type="number" placeholder='Total Person' id='guestSize' required onChange={handleChange}/>
                </FormGroup>
            </Form>
          </div>
